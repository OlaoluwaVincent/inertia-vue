  ...
  >
    ...
    <aside class="tw-w-full tw-flex tw-flex-col tw-gap-3">
      ...
      <form @submit.prevent="submit">
        ...
        <div class="mt-4 tw-inline-flex tw-gap-3">
          <InputLabel for="instructor" value="Register as an Instructor" />
          <span
            class="tw-border tw-border-black tw-h-4 tw-w-4 tw-flex tw-items-center tw-justify-center"
          >
            <input
              type="checkbox"
              name="instructor"
          ...
          <InputError class="mt-2" :message="form.errors.instructor" />
        </div>

        <div
          class="tw-flex tw-items-center tw-justify-center md:tw-justify-end tw-mt-4"
        >
          <Link
            :href="route('login')"
