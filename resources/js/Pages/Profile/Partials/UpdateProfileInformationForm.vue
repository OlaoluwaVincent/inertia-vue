    ...
    <section>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="tw-mt-6 tw-space-y-6">
            <div>
                ...
                <TextInput id="name" type="text" class="tw-border tw-border-primary-70 tw-mt-1 tw-block tw-w-full"
            ...
            <div>
                ...
                <TextInput id="email" type="email" class="tw-border tw-border-primary-70 tw-mt-1 tw-block tw-w-full"
