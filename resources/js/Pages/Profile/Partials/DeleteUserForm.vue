            ...
            <div class="tw-p-6">
                ...
                <div class="tw-mt-6">
                    ...
                    <TextInput id="password" ref="passwordInput" v-model="form.password" type="password"
                        class="tw-mt-1 tw-block tw-w-3/4" placeholder="Password" @keyup.enter="deleteUser" />
                ...
                <div class="tw-mt-6 tw-flex tw-justify-end">
                    ...
                    <v-btn class="tw-ms-3" tile color="error" @click="deleteUser"
                        :class="{ 'tw-opacity-25': form.processing }" :disabled="form.processing">
                        Delete Account
                    </v-btn>
                </div>
            </div>
